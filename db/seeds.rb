...
tools = [
  {
    ...
    allowed_roles: %w[assistant operator],
    enabled: true
  },
  {
    name: 'write',
  ...
  {
    name: 'memory_get',
    description: 'Get memories from storage',
    allowed_roles: %w[assistant],
    enabled: true
  },
  {
...
memories_data = [
  {
    ...
    memory_type: 'long',
    importance: 4,
    tags: %w[owner personal family]
  },
  {
    content: "Gabriel works at ITLab, his company. He has 25+ years of experience in tech.",
    memory_type: 'long',
    importance: 4,
    tags: %w[work itlab]
  },
  {
    content: "Gabriel loves F1 (fan of Fernando Alonso), Golf (follows Joaquín Niemann), RC Cars, 3D printing, electronics, DJing, and board games.",
    memory_type: 'semantic',
    importance: 3,
    tags: %w[hobbies sports]
  },
  {
    content: "Gabriel's phone: +56972673878. Email: gabriel@itlab.cl",
    memory_type: 'long',
    importance: 4,
    tags: %w[contact]
  },
  {
    content: "Spot operates with HITL protocol - always wait for Gabriel's OK before executing critical changes.",
    memory_type: 'semantic',
    importance: 4,
    tags: %w[protocol hitl]
  }
]
